...
namespace Yılan
{
    public class Enemy1 : EnemyBase
    {
        ...
        public Enemy1(BattlePhase battlePhase, float x, float y)
            : base(battlePhase)
        {
            this.x = x;
            this.y = y;
        ...
        {
            Camera.DrawRectGraph(x, y, imageWidth * (animationCounter / 16 % 2), imageHeight, imageWidth, imageHeight, Image.Enemy1, direction, playerDistanceX, playerDistanceY, attackFlg);
        }
    }
}
